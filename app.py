    ...
    try:
        ...
        try:
            ...
            if (hasattr(agent, '_tool_registry') and 
                ...
                if function_name in ['process_payment']:
                ...
                if function_name in ['pay_order', 'process_payment'] and call_id:
